...
# Initialize the Qdrant client with the correct URL and API key
client = QdrantClient(
    url="https://86978d70-5270-493a-879d-8633c5ad0b88.us-east4-0.gcp.cloud.qdrant.io:6333",
    api_key="qT6PMSKiR5NdA_sCXzQx8Ki2INdVJvro8YSJLvldWHEds_bJtlZcyA"
)
API_KEY = os.getenv("OPENAI_API_KEY")
...
st.sidebar.markdown("""
    ...
    **LinkedIn:** [Muhammad Abdullah](https://www.linkedin.com/in/muhammad-abdullah-41b82028b/)  
    **GitHub:** [Muhammad Abdullah](https://github.com/abdullah0325)  
""")
